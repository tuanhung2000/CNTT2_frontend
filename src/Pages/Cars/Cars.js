      ...
      >
        ...
        <div className="bottom-filter">
          ...
          <div
            ...
            style={{
              border:
                activeFilter === 1 ? "1px solid #00a550" : "1px solid #c6c6c6",
            }}
          ...
          <div
            ...
            style={{
              border:
                activeFilter === 2 ? "1px solid #00a550" : "1px solid #c6c6c6",
            }}
          ...
          <div
            ...
            style={{
              border:
                activeFilter === 3 ? "1px solid #00a550" : "1px solid #c6c6c6",
            }}
            onClick={() => handleRent()}
          >
            <FaMoneyBillAlt />
          ...
          <div
            ...
            style={{
              border:
                activeFilter === 4 ? "1px solid #00a550" : "1px solid #c6c6c6",
            }}
              ...
              return (
                ...
                >
                  <input
                    ...
                    id={item.name}
                    type="radio"
                    checked={selectedCar === item.name}
                    style={{
                      cursor: "pointer",
                    }}
                    onChange={() => setSelectedCar(item.name)}
                  ></input>
                  <label
                    htmlFor={item.name}
                    style={{
